...
#### Scenario: Shared contract applies to current governed prompt templates

- **WHEN** a researcher inspects a governed prompt template such as `act/discovery/prompt.md` or `act/rating/prompt.md`
- **THEN** the prompt contains a `### Markdown and Formatting Rules` section that follows this shared contract
