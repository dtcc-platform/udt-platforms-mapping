...
Platform discovery SHALL prefer replacing weaker candidates with stronger candidates when the stronger candidates have clearer evidence and a better fit to `entity-definition`.
...
Platform discovery SHALL classify every included seed-list candidate using `entity-definition`.
...
- **THEN** platform discovery includes the candidate when evidence satisfies `entity-definition`
