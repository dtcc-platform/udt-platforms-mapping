...
The repository SHALL contain `act/platform-discovery-benchmark.md`.
...
The live `act/platform-discovery-benchmark.md` prompt body SHALL avoid duplicating behavior supplied by required contracts.

#### Scenario: Researcher runs platform discovery benchmark

- **WHEN** a researcher runs `act/platform-discovery-benchmark.md`
