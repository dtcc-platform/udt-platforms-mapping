...
The repository SHALL contain `act/platform-discovery-report.md`.
...
The live `act/platform-discovery-report.md` prompt body SHALL avoid duplicating behavior supplied by required contracts.

#### Scenario: Researcher runs platform discovery reporting

- **WHEN** a researcher runs `act/platform-discovery-report.md`
