...
The repository SHALL contain `act/platform-comparison-report.md`.
...
The live `act/platform-comparison-report.md` prompt body SHALL avoid duplicating behavior supplied by required contracts.

#### Scenario: Researcher runs platform comparison reporting

- **WHEN** a researcher runs `act/platform-comparison-report.md`
