...
Defines the complete discovery benchmarking workflow in `reflect/discovery/benchmarking/`, including the benchmark fixture, alias semantics, CLI eval prompt, and the coverage report it writes.
