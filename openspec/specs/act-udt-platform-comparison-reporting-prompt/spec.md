# Spec: act-udt-platform-comparison-reporting-prompt

## Purpose

Defines the flattened `act/udt-platform-comparison-reporting.md` reporting prompt for the `udt-platform-comparison` thread.
