...
Defines the structure and naming conventions for coverage reports generated by the discovery eval prompt. Reports are saved to `tests/reports/` and enable tracking of recall performance across models and over time.
