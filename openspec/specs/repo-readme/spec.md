...
It SHALL include examples such as `act-platform-comparison`, `act-platform-comparison-report`, `plan-platform-comparison-rubric`, and `plan-platform-source-policy` when explaining formal spec names.
...
- **THEN** they understand comparison spec names such as `act-platform-comparison`, `act-platform-comparison-report`, and `plan-platform-comparison-rubric`
