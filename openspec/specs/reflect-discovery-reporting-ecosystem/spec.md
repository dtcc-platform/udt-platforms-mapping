...
Defines the requirements for `reflect/discovery/reporting/ecosystem.csv` — the canonical inventory of UDT platforms, stored in CSV format with one row per platform per research session.
