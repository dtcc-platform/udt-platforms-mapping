# Spec: workflow-presentation

## Purpose

Defines the workflow presentation area at `workflow/presentation/`, including the CLI generator prompt, the generated Pandoc-ready deck, and the tutorial arc the deck must teach.
