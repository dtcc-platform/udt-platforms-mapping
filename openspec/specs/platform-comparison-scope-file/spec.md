# Spec: platform-comparison-scope-file

## Purpose

TBD — Defines the requirements for `docs/01-comparison-scope.md`, the scope reference file for comparison sessions. Researchers paste its full content into the `[PASTE_SCOPE_HERE]` slot in the comparison prompt before running a session.
