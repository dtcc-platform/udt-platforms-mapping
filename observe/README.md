...
`observe/` contains saved model outputs and generated workflow outputs.
...
Generated workflow outputs also live here as direct files when they are observations of a run.
