...
Copy the prompt below, replace `[PLATFORM_NAME]` with the platform name, provide the license
...
Your task is to assess the software license and data licensing posture of the platform below.

**Platform:** [PLATFORM_NAME]

**License source (URL or pasted text):**
[LICENSE_URL_OR_TEXT]
