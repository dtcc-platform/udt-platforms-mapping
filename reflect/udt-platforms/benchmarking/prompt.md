...
> "Run the udt-platforms eval" or "Run reflect/udt-platforms/benchmarking/prompt.md"
...
Read `reflect/udt-platforms/benchmarking/benchmark.md`. Extract all expected artifacts from the single table with:
...
Glob all files matching `observe/udt-platforms/*.md`.
...
Write the report to `reflect/udt-platforms/benchmarking/coverage.md`. Overwrite it if it already exists.
...
**Fixture:** reflect/udt-platforms/benchmarking/benchmark.md
