...
Use this prompt to produce `reflect/udt-platform-comparison/reporting/ecosystem.csv` and `reflect/udt-platform-comparison/reporting/ecosystem-map.html` from qualifying comparison response files in `observe/udt-platform-comparison/`.
...
2. The model will scan `observe/udt-platform-comparison/` automatically
3. Save the generated files to `reflect/udt-platform-comparison/reporting/`
...
Your task is to scan `observe/udt-platform-comparison/`, extract the Part 1 scoring-table rows from qualifying comparison responses, and write two files:

- `reflect/udt-platform-comparison/reporting/ecosystem.csv`
- `reflect/udt-platform-comparison/reporting/ecosystem-map.html`

**Do not ask for file paths or user input.** Read `observe/udt-platform-comparison/` directly using your file tools.

### Step 1 — Identify qualifying files

Read all files in `observe/udt-platform-comparison/`.
...
Write `reflect/udt-platform-comparison/reporting/ecosystem.csv` with exactly this header row:
...
Write `reflect/udt-platform-comparison/reporting/ecosystem-map.html` as a self-contained HTML file that visualizes the same row set used in `ecosystem.csv`.
