...
It is a required input of `act/compare-platforms.md`.
...
This cycle is intentionally restricted to rows already classified as `Type = platform` in platform discovery.
