# Prompt Status Report — 2026-04-26
...
| ------------------------------------------ | --------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | -------------------------------------------------------- |
| `act/discovery/prompt.md`                  | `valid`         | `openspec/specs/act-discovery-prompt/spec.md`               | `openspec/specs/prompt-run-modes/spec.md`, `openspec/specs/prompt-markdown-format/spec.md` | `plan/discovery/scope.md`                                                            | Prompt and contract are aligned                          |
...
- **Findings:**
  - The prompt declares the required input expected by its governing spec.
...
- **Findings:**
  ...
  - The live prompt is aligned with the current core-platform-only rating workflow.
  - The governing spec still contains stale wording in its Required Inputs section describing `plan/rating/platforms.md` as if it carried `Layer`.
  - This is an internal contract drift signal, so the prompt is marked `review-needed`.
...
- **Prompt git reference:** `07592f5 2026-04-23 feat: replace prompt paste mechanic with CLI/Web run modes`
- **Newer dependency references:** `96ebef9 2026-04-24 refactor: unify discovery benchmarking specs`
- **Findings:**
  - The prompt is governed by the unified baseline spec at `openspec/specs/reflect-discovery-benchmarking/spec.md`.
...
- **Findings:**
  ...
  - The live prompt sorts by a shared base-domain family key so related DTCC host variants stay together.
...
- **Prompt git reference:** `2c32b95 2026-04-24 refactor: restrict rating workflow to core platforms`
- **Newer dependency references:** `f6331b8 2026-04-24 refactor: consolidate reporting specs and retire legacy baselines`
- **Findings:**
  - The live prompt is governed by the merged baseline spec at `openspec/specs/reflect-rating-reporting/spec.md`.
  - The prompt-status audit mapping is aligned with that merged capability.
