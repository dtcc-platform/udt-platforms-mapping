...
Use this prompt to produce `reflect/udt-platforms-ecosystem.md` from qualifying `udt-platforms` response files matching `observe/udt-platforms-web-*.md`.
...
2. The model will scan `observe/udt-platforms-web-*.md` automatically
3. Save the generated output to `reflect/udt-platforms-ecosystem.md`
...
Your task is to scan `observe/udt-platforms-web-*.md`, extract the summary-table rows from qualifying `udt-platforms` responses only, and write one consolidated Markdown table to `reflect/udt-platforms-ecosystem.md`.

**Do not ask for file paths or user input.** Read files matching `observe/udt-platforms-web-*.md` directly using your file tools.

### Step 1 — Identify qualifying files

Read all files matching `observe/udt-platforms-web-*.md`.
...
`reflect/udt-platforms-ecosystem.md`
