...
3. Produce one resolved prompt:
   - start with the manifest's `## Prompt` body as the executable research query
...
- The saved resolved prompt must be runner-first: no metadata or contract text before the executable research query.
